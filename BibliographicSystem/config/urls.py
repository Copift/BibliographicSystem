...
from BibliographicSystem.app.views.author import AuthorHomeView, update_author_profile, author_profile, login_view
from BibliographicSystem.app.views.conference import ConferenceDetailView
from BibliographicSystem.app.views.journal import JournalDetailView
from BibliographicSystem.app.views.publication import fetch_doi_data, journal_list_api, conference_list_api, \
